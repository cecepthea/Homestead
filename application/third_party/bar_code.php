 ...
 *
 *
function pdf_barcode($param_im, $param_x, $param_y, $param_width, $param_height = '20', $text = '0', $code_type = 'code128', $orientation = "horizontal"){

    $size = $param_height;
	$code_string = "";

	//imagecopy($param_im, $image, $param_x, $param_y, 0, 0, $img_width, $img_height);
